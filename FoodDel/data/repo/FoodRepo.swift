...
class FoodRepo{
    ...
    func loadFoods(){
        AF.request(baseUrl+"foods/getAllFoods.php", method: .get).response {response in
    ...
    func confirmOrder(cartList: [CartModel]){
        ...
        for item in cartList{
            ...
            AF.request(baseUrl+"foods/insertFood.php", method: .post, parameters: params).response { response in
                if let data = response.data{
                    do{
    ...
    func loadOrders(userName: String){
        ...
        AF.request(baseUrl+"foods/getFoodsCart.php", method: .post, parameters: params).response { response in
    ...
    func deleteOrder(orderId:Int, userName: String){
        ...
        AF.request(baseUrl+"foods/deleteFood.php", method: .post, parameters: params).response { response in
            if let data = response.data{
                do{
                    let result = try JSONDecoder().decode(CRUDResponse.self, from: data)
                    print("Success: \(result.success!)")
